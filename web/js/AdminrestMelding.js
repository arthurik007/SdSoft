		...
		div.innerHTML =
                       "<table>\
                        ...
                        <td>"+melding.gebruikernaam+"</td>\
                         ...
                         <tr>\
                        <td><button type='button' id='meldingDeleteButton'  onclick=deleteMeldingButton('" + melding.meldingID + "'); >Verwijderen</button><br></td>\
                        </tr>\
                        </table>";          
...
function knoppenVoorbereiden()
{
    ...
    $("meldingDeleteButton").click(function()
    {
        deleteMeldingButton(id);
    });
...
function deleteMelding()
{
 ...
 function deleteMeldingButton(id)
{
    var nummer;
    var melding = {};
    melding.meldingID = id;
    nummer = melding.meldingID;
    var login = prompt("Bent u zeker ? (1 of y voor ja)");
