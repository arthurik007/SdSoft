		...
		//div.setAttribute("class", "saleItem");
                div.innerHTML = 
                        ...
                        <td>"+evenement.gebruikernaam+"</td>\
                         ...
                         <tr>\
                        <td><button type='button' id='evenementDeleteButton'  onclick=deleteEvenementButton('" + evenement.evenementenID + "'); >Verwijderen</button></td>\
                        </tr>\
                        </table>";
...
function knoppenVoorbereiden()
{
    ...
    $("evenementDeleteButton").click(function()
    {
        deleteEvenementButton(id);
    });
...
function deleteEvenement()
{
    ...
    var login = prompt("Bent u zeker ? (1 of y voor ja)");
...
function deleteEvenementButton(id)
{
    var nummer;
    var evenement = {};
    evenement.evenementenID = id;
    nummer = evenement.evenementenID;
    var login = prompt("Bent u zeker ? (1 of y voor ja)");
